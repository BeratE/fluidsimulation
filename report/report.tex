...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{images/tension.0120.png}
  \caption{Frame 160 of simulations of 19683 particles arranged in a block without gravity using the WCSPH and the PBF solver. In all simulations, smoothing was disabled. For simulations using WCSPH, \texttt{max\_timestep = 0.002, stiffness = 3000, fluid\_visc = 0.01 }. 
  For simulations using PBF, \texttt{max\_timestep = 0.01, nr\_iterations = 5, fluid\_visc = 0.001}. \texttt{tension} is set as indicated in the panels.}
  \label{fig:tension}
\end{figure*}
...
\begin{figure*}
  ...
  \caption{Frame 160 of simulations of 67868 fluid particles falling onto an icosahedron using the WCSPH and the PBF solver. In all simulations, a linear drag force of 0.025 was applied. For simulations using WCSPH, \texttt{max\_timestep = 0.0005s,
