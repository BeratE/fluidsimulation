...
TEST_CASE("Tension on funnel", "[tension_funnel]") {
	...
	SECTION("SPH") {
		...
		SECTION("OFF") {
			solver.run("new_sph_funnel_no_tension_no_adhesion", 4000);
		}
		...
		SECTION("BETA250") {
			...
			plane3.setBeta(250);
			plane4.setBeta(250);
			solver.run("new_sph_funnel_250_beta", 4000);
		}
		...
		SECTION("BETA500") {
			...
			plane3.setBeta(500);
			plane4.setBeta(500);
			solver.run("new_sph_funnel_500_beta", 4000);
		}
	}
