...
namespace learnSPH {
    namespace Simulator {
        ...
        void semiImplicitEuler(ParticleSystem::FluidSystem& fluid,
                               const CompactNSearch::NeighborhoodSearch& nsearch,
                               const double defaultTimeStep = 0.01,
                               const double epsilon = Kernel::Parameter::EPSILON,
                               bool smoothing = true);
        ...
        void simulate(ParticleSystem::FluidSystem& fluid,
